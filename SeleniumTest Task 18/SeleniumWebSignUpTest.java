...
@Test (priority = 0)
  public void PositiveSignUp() throws InterruptedException {
    ...
    driver.findElement(By.id("user_username")).sendKeys("Nippjljdee");

    //6.input your email on the email field
    driver.findElement(By.id("user_email")).sendKeys("ndhhztde@gmail.com");
...
@Test (priority = 4)
    ...
    driver.findElement(By.id("user_email")).sendKeys("nzegg@gmail.com");
...
@Test (priority = 5)
    ...
    //input your username on the username field
    driver.findElement(By.id("user_username")).sendKeys("Nejje");

    //input your email on the email field
    driver.findElement(By.id("user_email")).sendKeys("n");
